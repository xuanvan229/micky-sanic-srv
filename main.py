...
pairs = (
    ...
    (
        ...
        (
            "ur funny! kekeke",
            "boooooring! talk about szomething else! tell me wat u like!",
            "do u like anime??",
...
def demo():
    print(iesha_chatbot.respond("My name is Xuan"))
...
async def test(request):
	...
	logger.warn("logger %r", request_data)
	resp = iesha_chatbot.respond(request_data)
	return json({"hello":resp})
